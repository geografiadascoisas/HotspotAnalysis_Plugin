...
class MoranLocal(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        return (
            "<p>Computes <b>Local Moran's I</b> (Anselin 1995) for each feature.</p>"
            '<p>Classifies features into four quadrant types:<br>'
            '&nbsp;&nbsp;<b>HH (1)</b> — high value surrounded by high values<br>'
            '&nbsp;&nbsp;<b>LH (2)</b> — low value surrounded by high values<br>'
            '&nbsp;&nbsp;<b>LL (3)</b> — low value surrounded by low values<br>'
            '&nbsp;&nbsp;<b>HL (4)</b> — high value surrounded by low values</p>'
            ...
            'approach in the spatial statistics literature (Anselin 1995) '
            'and in major reference implementations. The local Moran test '
            'is directional: each quadrant (HH, LH, LL, HL) represents a '
            'specific spatial configuration, not a symmetric deviation.<br>'
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        feedback.pushInfo(
            f"Local Moran's I complete — {len(features_data)} features  |  "
            f'{threshold_used}'
        )
